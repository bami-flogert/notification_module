...
| R6 | **FHIR R4** als alternatief intake-pad | Behaald |
...
| R6 | `FhirAppointmentController`; [ADR 0010](madr/0010-fhir-integratie.md) | FHIR mapping | `FhirAppointmentMapperTests` | `POST /fhir/Appointment` → 201/200 |
